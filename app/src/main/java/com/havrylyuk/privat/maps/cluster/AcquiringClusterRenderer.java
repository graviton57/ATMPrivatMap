...
public class AcquiringClusterRenderer extends DefaultClusterRenderer<PointItem> {
    ...
    public AcquiringClusterRenderer(Activity context, GoogleMap map, ClusterManager clusterManager) {
    ...
    protected void onBeforeClusterItemRendered(PointItem item, MarkerOptions markerOptions) {
        ...
        markerOptions.icon(BitmapDescriptorFactory.fromBitmap(icon))
                .title(Utility.getNameFromType(context, item.getType()))
                .snippet(Utility.normalizeStr(item.getPlaceRu()));
    }
